...
insert into SANPHAM(MaSP,TenSP,NgaySX) VALUES('SP01',N'Áo thun',20151101)
insert into SANPHAM(MaSP,TenSP,NgaySX) VALUES('SP02',N'Áo Sơmi',20140907)
insert into SANPHAM(MaSP,TenSP,NgaySX) VALUES('SP03',N'Áo thun',20131004)
insert into SANPHAM(MaSP,MaSP,NgaySX) VALUES('SP04',N'Áo POLO',20140705)
insert into SANPHAM(MaSP,TenSP,NgaySX) VALUES('SP05',N'Áo Sơmi',20151212)
insert into SANPHAM(MaSP,TenSP,NgaySX) VALUES('SP06',N'Áo giữ nhiệt',20160910)
insert into SANPHAM(MaSP,TenSP,NgaySX) VALUES('SP07',N'Áo thun',20170312)
insert into SANPHAM(MaSP,TenSP,NgaySX) VALUES('SP08',N'Áo POLO',20140804)
insert into SANPHAM(MaSP,TenSP,NgaySX) VALUES('SP09',N'Áo Hoodie',20160412)
insert into SANPHAM(MaSP,TenSP,NgaySX) VALUES('SP10',N'Áo Sơmi',20131212)
insert into SANPHAM(MaSP,TenSP,NgaySX) VALUES('SP11',N'Áo POLO',20151111)
insert into SANPHAM(MaSP,TenSP,NgaySX) VALUES('SP12',N'Áo Hoodie',20140301)
insert into SANPHAM(MaSP,TenSP,NgaySX) VALUES('SP13',N'Áo Giữ nhiệt',20110509)
insert into SANPHAM(MaSP,TenSP,NgaySX) VALUES('SP14',N'Áo Giữ nhiệt',20140612)
insert into SANPHAM(MaSP,TenSP,NgaySX) VALUES('SP15',N'Áo Hoodie',20120811)

select *from KHOHANG

select into KHOHANG(MaSP,Size,SL,GiaNhap,GiaBan) VALUES('SP01',N'M','255','50000','100000')
select into KHOHANG(MaSP,Size,SL,GiaNhap,GiaBan) VALUES('SP02',N'L','200','100000','130000')
select into KHOHANG(MaSP,Size,SL,GiaNhap,GiaBan) VALUES('SP03',,N'L','150','30000','80000')
select into KHOHANG(MaSP,Size,SL,GiaNhap,GiaBan) VALUES('SP04',N'S','120','70000','230000')
select into KHOHANG(MaSP,Size,SL,GiaNhap,GiaBan) VALUES('SP05',N'M','300','80000','170000')
select into KHOHANG(MaSP,Size,SL,GiaNhap,GiaBan) VALUES('SP06',N'S','500','40000','100000')
select into KHOHANG(MaSP,Size,SL,GiaNhap,GiaBan) VALUES('SP07',N'S','550','45000','90000')
select into KHOHANG(MaSP,Size,SL,GiaNhap,GiaBan) VALUES('SP08',N'M','150','60000','140000')
select into KHOHANG(MaSP,Size,SL,GiaNhap,GiaBan) VALUES('SP09',N'M','220','200000','350000')
select into KHOHANG(MaSP,Size,SL,GiaNhap,GiaBan) VALUES('SP10',N'S','255','85000','180000')
select into KHOHANG(MaSP,Size,SL,GiaNhap,GiaBan) VALUES('SP11',N'L','210','75000','260000')
select into KHOHANG(MaSP,Size,SL,GiaNhap,GiaBan) VALUES('SP12',N'L','170','180000','310000')
select into KHOHANG(MaSP,Size,SL,GiaNhap,GiaBan) VALUES('SP13',N'M','135','50000','100000')
select into KHOHANG(MaSP,Size,SL,GiaNhap,GiaBan) VALUES('SP14',N'L','230','60000','110000')
select into KHOHANG(MaSP,Size,SL,GiaNhap,GiaBan) VALUES('SP15',N'S','270','190000','250000')
